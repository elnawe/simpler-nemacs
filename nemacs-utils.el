...
;; Remap keybindings
(global-set-key [remap save-buffers-kill-emacs] #'nemacs-prompt-before-exiting-emacs) ;; C-x C-c
(global-set-key [remap save-buffers-kill-terminal] #'nemacs-prompt-before-exiting-emacs) ;; C-x C-c

(global-set-key [remap move-beginning-of-line] #'nemacs-move-beginning-of-line) ;; C-a
(global-set-key [remap org-beginning-of-line] #'nemacs-move-beginning-of-line) ;; C-a

(global-set-key [remap suspend-frame] #'ignore) ;; C-z

(global-set-key [remap split-window-right] #'nemacs-create-window-right-and-switch) ;; C-x 3
